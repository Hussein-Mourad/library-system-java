 ...
 * @author hussein
 */
public class LibrariansTable extends javax.swing.JFrame {

    /**
     * Creates new form LibrariansTable
     */
    public LibrariansTable() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibrariansTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
